...
<head>
    <meta charset="utf-8">
    <title>Si Ocong - Personal Portfolio</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand d-block d-lg-none">
            <h1 class="text-primary fw-bold m-0">Si Ocong</h1>
        </a>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <div class="typed-text d-none">Cyber Security Analyst, Bug Bounty Hunter, Front End Developer, Backend Developer, App Developer</div>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="assets/img/bg-hero.jpg" width="625" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <h3 class="lh-base mb-0">of working experience as a web developer</h3>
                    </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="testimonial-right h-100">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.1s" src="assetsimg/testimonial-1.jpg" alt="">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.3s" src="assets/img/testimonial-2.jpg" alt="">
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.5s" src=assetsimg/testimonial-3.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="assetslib/wow/wow.min.js"></script>
